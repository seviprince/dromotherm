...
def graphe(s,e):
    ...
    ax4.plot(xrange, RSB.Tinj_pac[s:e], label="Tinj_pac", color="red")
    ax4.plot(xrange, RSB.Tsor_pac[s:e], label="Tsor_pac", color="#7cb0ff")
    ax4.legend()
    ...
    ax5.plot(xrange, RSB.agenda_pac[s:e], color=clearblue, label="PAC ON/OFF")
    ax5.legend(loc="upper left")
    
    ax51 = ax5.twinx()
    ax51.plot(xrange, besoin_total[s:e], label="besoin {} en W > {} kWh > Elec {} kWh".format(heating,int(conso_bat),int(Eelec)), color="orange")
