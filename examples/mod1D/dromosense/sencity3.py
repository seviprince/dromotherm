...
class SenCityOne:
    ...
    def __init__(self,size,step):
        ...
        self.Tinj_sto=14*np.ones(size)
        self.Tsor_sto=14*np.ones(size)
        
        self.Tsor_pac=10*np.ones(size)
        self.Tinj_pac=10*np.ones(size)
        
        self.Tsable=14*np.ones(size)
    ...
    def SystemLoop(self,i,qdro_u,dromo):
        ...
        ********************************************************************************       
        ...
        # étape 2
        if pac == 1 :
            self.COP[i]=6.83-0.0822*(60-self.Tinj_pac[i])
